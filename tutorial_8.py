...
def bilateralFilter_demo(image):
    ...
    cv.imwrite("c:/Users/fenjin/PycharmProjects/images/bilateralFilter_image.jpg", dst)


def pyrMeanShiftFiltering_demo(image):
    dst = cv.pyrMeanShiftFiltering(image, 10, 50)
    cv.imshow("pyrMeanShiftFiltering", dst)
    cv.imwrite("c:/Users/fenjin/PycharmProjects/images/pyrMeanShiftFiltering_image.jpg", dst)
